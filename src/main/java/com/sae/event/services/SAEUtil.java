package com.sae.event.services;
...
public class SAEUtil {
    ...
    public static Event getEvent(UnmanagedServiceDAO serviceDAO){

        serviceDAO.openSession();

        Event selectedEvent = null;
        try {
            List<Event> eventList = serviceDAO.findAll(com.sae.event.core.Event.class);
