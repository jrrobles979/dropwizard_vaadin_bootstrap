...
import com.sae.api.db.ManagedHibernateServiceDAO;
...
@Title("SAE UI")
@Theme("valo")
@Widgetset("com.sae.api.ui.AppWidgetSet")
...
public class HomeUI extends UI{
    ...
    public ManagedServiceDAO getServiceDAO(){
        ManagedServiceDAO serviceDAO = new ManagedHibernateServiceDAO(sessionFactory);
        return serviceDAO;
    }
}
